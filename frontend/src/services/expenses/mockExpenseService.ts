...
let categories: ExpenseCategory[] = [
  ...
  { id: "cat4", name: "Equipment", description: "Coffee machines, blenders, POS", isActive: true },
  { id: "cat5", name: "Maintenance", description: "Repairs and standard maintenance", isActive: true },
  { id: "cat6", name: "Transportation", description: "Delivery and travel expenses", isActive: true },
  { id: "cat7", name: "Marketing", description: "Ads and promotions", isActive: true },
